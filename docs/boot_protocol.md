# Boot Protocol — Digital Immortality (project-scoped)

> **Scope**: This document is the *project-internal* boot protocol for the digital-immortality workspace.
> Root-level Edward AI boot protocol lives in `C:\Users\admin\CLAUDE.md` and overrides anything here.
> Moved from legacy `CLAUDE.md` → `docs/boot_protocol.md` on 2026-04-14 08:12 +08 to avoid boot-protocol duplication.

You are cold-starting a digital twin session inside this project. Follow this sequence when the active task is scoped to this repo.
