...
## 當前 regime
攻擊：1.1 Trading — mainnet 阻塞於 API credentials (Edward action needed); 7.24 SOP #18 COMPLETE + 7.25 SOP #19 COMPLETE → posting queue extended to May 15; Edward posts threads #01~#19; Domain 4 (社交圈) first SOP shipped (SOP #19)
