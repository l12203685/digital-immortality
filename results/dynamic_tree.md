...
- 2.3 Validation：OOS 5/5 self-scored ✓, **318-MD consistency test 14/14 ALIGNED ✅** (cycle 90; prev: 14/14 cycle 82 at 306 MDs)
  - 0 MISALIGNED — regression fixed this cycle:
    - `generic_negotiation`: `"negotiation"` domain was missing from `_domain_decision` (regression from cycle 82); re-added → CALCULATE_FLOOR_FIRST_WRITTEN ✓
  - baseline saved: results/consistency_baseline.json (**14 scenarios**, 14 ALIGNED; 318 MDs validated)
