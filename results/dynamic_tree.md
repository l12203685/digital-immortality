...
- 1.2 Trading code: strategies.py (DualMA+Donchian+RegimeFilter+DonchianConfirmed+**RSIFilter** ✓ cycle 45) — 8 strategies in NAMED_STRATEGIES; RSIFilter gates signals by RSI>50 long / RSI<50 short
  ...
  - **MAE/MFE wired into `cmd_backtest --backtest` output ✓** (cycle 47) — shows per-strategy edge_ratio alongside GO/NO-GO verdict
  - **DonchianConfirmed + DualMA_RSI + DualMA_RSI_filtered added to backtest_framework.py MAE/MFE demo ✓** (cycle 47) — `_EXTRA_STRATEGIES` import block; all 7 strategies now compared in demo
...
## 已完成 milestones
- dna_core.md 201 MDs operational（core + MD-01~MD-201 written ✓）
- boot_tests 13 題
...
- 2026-04-08T18:00Z cycle 47: MD-193~MD-201 written to dna_core.md (202004/202003/202002); MAE/MFE wired into testnet_runner --backtest; DonchianConfirmed+RSIFilter added to backtest_framework demo
