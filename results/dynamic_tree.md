...
- 2.3 Validation：OOS 5/5 self-scored ✓, **318-MD consistency test 18/18 ALIGNED ✅** (cycle 92; prev: 16/16 cycle 91)
  ...
  - MD-313 added to `capital_allocation` domain decision text
  - baseline saved: results/consistency_baseline.json (**18 scenarios**, 18 ALIGNED; 318 MDs validated)
