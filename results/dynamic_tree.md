...
- 1.1 Trading system → live profit
  ...
  - **`bollinger_mr` added to testnet_runner.py STRATEGIES ✓ (cycle 74)** — BollingerMR_20 now tracked in testnet; STRATEGY_MIN_LOOKBACK=52; STRATEGY_PORTFOLIO_NAME maps to "BollingerMR_20"
...
- 2.6 健康資本 context：templates/example_dna.md §9 Health & Physical Capital added ✓ (cycle 74) (leverage asset, consistency>intensity, preventive maintenance EV)
