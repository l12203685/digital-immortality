...
- **commits_in_window**: 58
- **window_hours**: 24
- **min_required**: 1
- **lyh_commits_in_window**: 16

### STALE_BRANCH (GREEN)

- **registry_path**: C:\Users\admin\LYH\agent\tree_registry\branches
- **stale_yellow_days**: 7
- **stale_red_days**: 14
- **branches_checked**: 22
- **stale_yellow**: []
...
- DEAD_LOOP: incremented dead_loop_count to 1; wrote branch-switch directive to daemon_next_priority.txt
